...
const createWindow = () => {
  ...
  require$$3$1.globalShortcut.register("Ctrl+W", () => {
    mainWindow2.webContents.send("global-shortcut", "Electron loves global shortcuts!");
  });
  mainWindow2.webContents.openDevTools();
};
require$$3$1.app.whenReady().then(() => {
  require$$3$1.ipcMain.handle("get-cursor-position", () => {
    return require$$3$1.screen.getCursorScreenPoint();
  });
  require$$3$1.session.defaultSession.setDisplayMediaRequestHandler(
    (request, callback) => {
      require$$3$1.desktopCapturer.getSources({ types: ["screen"] }).then((sources) => {
